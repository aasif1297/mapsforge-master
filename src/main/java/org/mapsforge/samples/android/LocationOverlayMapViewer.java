...
public class LocationOverlayMapViewer extends DownloadLayerViewer implements LocationListener {
    ...
    private MyLocationOverlay myLocationOverlay2;
    Polyline polyline;
    ...
    protected void createLayers() {
        ...
        polyline = new Polyline(Utils.createPaint(AndroidGraphicFactory.INSTANCE.createColor(Color.BLUE), (int) (8 * mapView.getModel().displayModel.getScaleFactor()), Style.STROKE), AndroidGraphicFactory.INSTANCE);
...
//        this.mapView.getLayerManager().getLayers().add(this.myLocationOverlay);
        ...
        this.mapView.getLayerManager().getLayers().add(this.polyline, false);
...
//        this.myLocationOverlay.setPosition(location.getLatitude(), location.getLongitude(), location.getAccuracy());
        ...
        LatLong latLong1 = new LatLong(location.getLatitude(), location.getLongitude());

        List<LatLong> latLongs = new ArrayList<>();
        latLongs.add(latLong1);
        this.polyline.setPoints(latLongs);
